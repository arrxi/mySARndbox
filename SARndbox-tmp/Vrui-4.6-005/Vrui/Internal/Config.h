...
#define VRUI_INTERNAL_CONFIG_SYSCONFIGDIR "/usr/local/etc/Vrui-4.6"
#define VRUI_INTERNAL_CONFIG_HAVE_USERCONFIGFILE 1
#define VRUI_INTERNAL_CONFIG_USERCONFIGDIR ".config/Vrui-4.6"
#define VRUI_INTERNAL_CONFIG_APPCONFIGDIR "Applications"
#define VRUI_INTERNAL_CONFIG_DEFAULTROOTSECTION "Desktop"

#define VRUI_INTERNAL_CONFIG_VERSION 4006005
#define VRUI_INTERNAL_CONFIG_ETCDIR "/usr/local/etc/Vrui-4.6"
#define VRUI_INTERNAL_CONFIG_SHAREDIR "/usr/local/share/Vrui-4.6"
